    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("flat_no", models.TextField(blank=True, max_length=200)),
                ("area", models.TextField(blank=True, default="", max_length=300)),
                ("city", models.TextField(default="", max_length=200)),
                ("state", models.TextField(default="", max_length=200)),
                ("pincode", models.TextField(default="", max_length=30)),
                (
                    "groups",
